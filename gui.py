...
class VPNTrackingApp(QMainWindow):
    def __init__(self):
        super().__init__()
        logger.info("Initializing VPN-TrackingApp GUI...")
        self.setWindowTitle("Soren - VPN Tracking")
    ...
    def _init_ui(self):
        ...
        header_label = QLabel("Soren - VPN Tracking")
    ...
    def _welcome_message(self):
        ...
        <div style="text-align:center; margin-top:50px;">
            <h2 style="color:#00FFAA;">Welcome to VPN Analyzer</h2>
